...
#Define image folder
image_folder = r'D:\Uni Work\Internship\Code\GitHub Repo\Talking-to-Plants-Summer-Work\Code\Offline Processing\Cultivar_assessment_SMFI\SMFI_stack__node_2_period_10_20230802_1010'
...
our_images_series = np.zeros((6, 6, total_images))
...
for n in range(total_images):
    ...
    sub_image = our_images[67:73, 67:73]
